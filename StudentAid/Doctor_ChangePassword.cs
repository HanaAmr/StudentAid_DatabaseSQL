...
{
    public partial class Doctor_ChangePassword : Form
    {
        ...
        private void Login_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                int r = controllerObj.DoctorChangePassword(textBox1.Text.ToString(), textBox2.Text.ToString());
                if (r != 0)
                {
                    object c = controllerObj.GetDoctorNameByUsername(textBox1.Text.ToString());
                    MessageBox.Show("Password changed succesfully, Enjoy!");
                    Doctor_Interface_Beg S = new Doctor_Interface_Beg();
