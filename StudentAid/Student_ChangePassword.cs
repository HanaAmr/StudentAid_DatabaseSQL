...
{
    public partial class Student_ChangePassword : Form
    {
        ...
        private void Login_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                int r = controllerObj.StudentChangePassword(textBox1.Text.ToString(),textBox2.Text.ToString());
                if (r!=0)
                {
                    object c = controllerObj.GetStudentNameUsingUsername(textBox1.Text.ToString());
